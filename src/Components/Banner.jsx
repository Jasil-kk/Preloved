...
const Banner = () => {
  return (
    <div className="w-full h-auto flex flex-wrap justify-center gap-6 px-10 pt-16  sm:pt-28 sm:px-24">
      {Array.from({ length: 17 }).map((_, idx) => (
        <div className="banner-card w-80 h-96 rounded-xl border border-gray-300 overflow-hidden relative">
            <span className="absolute right-3 top-3 text-3xl "><MdOutlineFavoriteBorder className="text-slade-400 hover:text-pink-400"/></span>
          <div className="image-section w-full h-1/2">
            <img
