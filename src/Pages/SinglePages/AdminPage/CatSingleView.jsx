  ...
  return (
    <div className="w-full min-h-screen bg-slate-300 flex justify-center items-start font-poppins">
      <div className="w-1/2 mt-20 h-auto p-5 bg-slate-50 flex flex-col items-center rounded-xl">
        ...
        <button className="w-auto ml-2 px-3 h-12 rounded-md flex items-center bg-green-600 text-slate-50">Update</button>
        <button className="w-auto ml-2 px-3 h-12 rounded-md flex items-center bg-red-600 text-slate-50">Delete</button>
        </div>
      </div>
    </div>
  );
